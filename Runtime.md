...
Like for the editor plugin there's a [GDScript version](../../releases/download/v2.1.8/runtime-v2.1.8-gdscript.zip) and a [CSharp version](../../releases/download/v2.1.8/runtime-v2.1.8-csharp.zip) available.  
