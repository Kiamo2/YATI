...
Like for the editor plugin there's a [GDScript version](../../releases/download/v1.6.4/runtime-v1.6.4-gdscript.zip) and a [CSharp version](../../releases/download/v1.6.4/runtime-v1.6.4-csharp.zip) available.  
