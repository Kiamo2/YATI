...
Like for the editor plugin there's a [GDScript version](../../releases/download/v2.2.1/runtime-v2.2.1-gdscript.zip) and a [CSharp version](../../releases/download/v2.2.1/runtime-v2.2.1-csharp.zip) available.  
