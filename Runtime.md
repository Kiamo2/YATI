...
Like for the editor plugin there's a [GDScript version](../../releases/download/v2.0.2/runtime-v2.0.2-gdscript.zip) and a [CSharp version](../../releases/download/v2.0.2/runtime-v2.0.2-csharp.zip) available.  

(Runtime downloads for Godot 4.2.x: [GDScript version](../../releases/download/v1.6.9/runtime-v1.6.9-gdscript.zip) and a [CSharp version](../../releases/download/v1.6.9/runtime-v1.6.9-csharp.zip))
