...
Like for the editor plugin there's a [GDScript version](../../releases/download/v2.2.5/runtime-v2.2.5-gdscript.zip) and a [CSharp version](../../releases/download/v2.2.5/runtime-v2.2.5-csharp.zip) available.  
