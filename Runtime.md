...
Like for the editor plugin there's a [GDScript version](../../releases/download/v1.6.5/runtime-v1.6.5-gdscript.zip) and a [CSharp version](../../releases/download/v1.6.5/runtime-v1.6.5-csharp.zip) available.  
