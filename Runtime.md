...
Like for the editor plugin there's a [GDScript version](../../releases/download/v2.2.3/runtime-v2.2.3-gdscript.zip) and a [CSharp version](../../releases/download/v2.2.3/runtime-v2.2.3-csharp.zip) available.  
