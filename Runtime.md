...
Like for the editor plugin there's a [GDScript version](../../releases/download/v2.2.6/runtime-v2.2.6-gdscript.zip) and a [CSharp version](../../releases/download/v2.2.6/runtime-v2.2.6-csharp.zip) available.  
