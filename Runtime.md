...
Like for the editor plugin there's a [GDScript version](../../releases/download/v1.6.2/runtime-v1.6.2-gdscript.zip) and a [CSharp version](../../releases/download/v1.6.2/runtime-v1.6.2-csharp.zip) available.  
