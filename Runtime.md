...
Like for the editor plugin there's a [GDScript version](../../releases/download/v2.1.2/runtime-v2.1.2-gdscript.zip) and a [CSharp version](../../releases/download/v2.1.2/runtime-v2.1.2-csharp.zip) available.  
