...
Like for the editor plugin there's a [GDScript version](../../releases/download/v2.2.0/runtime-v2.2.0-gdscript.zip) and a [CSharp version](../../releases/download/v2.2.0/runtime-v2.2.0-csharp.zip) available.  
