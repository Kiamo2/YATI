...
Like for the editor plugin there's a [GDScript version](../../releases/download/v2.2.7/runtime-v2.2.7-gdscript.zip) and a [CSharp version](../../releases/download/v2.2.7/runtime-v2.2.7-csharp.zip) available.  
