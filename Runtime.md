...
Like for the editor plugin there's a [GDScript version](../../releases/download/v2.0.3/runtime-v2.0.3-gdscript.zip) and a [CSharp version](../../releases/download/v2.0.3/runtime-v2.0.3-csharp.zip) available.  

(Runtime downloads for Godot 4.2.x: [GDScript version](../../releases/download/v1.6.10/runtime-v1.6.10-gdscript.zip) and a [CSharp version](../../releases/download/v1.6.10/runtime-v1.6.10-csharp.zip))
