...
Like for the editor plugin there's a [GDScript version](../../releases/download/v1.5.3/runtime-v1.5.3-gdscript.zip) and a [CSharp version](../../releases/download/v1.5.3/runtime-v1.5.3-csharp.zip) available.  
