...
Like for the editor plugin there's a [GDScript version](../../releases/download/v2.2.4/runtime-v2.2.4-gdscript.zip) and a [CSharp version](../../releases/download/v2.2.4/runtime-v2.2.4-csharp.zip) available.  
