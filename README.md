...
Tested on Windows 10 with Godot 4.6 and Tiled 1.12 (Tiled maps from older Tiled versions may work too)

Latest version: 2.2.6 (needs Godot 4.3.0 or higher)  
Downloads: [GDScript version](../../releases/download/v2.2.6/v2.2.6-gdscript.zip) / [CSharp version](../../releases/download/v2.2.6/v2.2.6-csharp.zip)
...
- Download either the [GDScript version](../../releases/download/v2.2.6/v2.2.6-gdscript.zip) or the [CSharp version](../../releases/download/v2.2.6/v2.2.6-csharp.zip)
