...
Tested on Windows 10 with Godot 4.0 and Tiled 1.10 (Tiled maps from older Tiled versions may work too)
...
- Download either the [GDScript version](../../releases/download/v1.2.0/v1.2.0-gdscript.zip) or the [CSharp version](../../releases/download/v1.2.0/v1.2.0-csharp.zip)
