...
||
| CollisionObject2D   | Disable Mode                       | Objects with class "staticbody" or "area" | disable_mode                             | int (enum)   | 0: Remove, 1: Make Static, 2: Keep Active                                                                                           |
...
||
| StaticBody2D        | Physics Material                   | Objects with class "staticbody"           | physics_material                         | file         |                                                                                                                                     |
